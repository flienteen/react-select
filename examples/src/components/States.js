	...
	render () {
		...
		return (
			<div className="section">
				...
				<Select ref="stateSelect" autofocus options={options} simpleValue clearable={this.state.clearable} multi name="selected-state" disabled={this.state.disabled} value={this.state.selectValue} resetValue="" onChange={this.updateValue} searchable={this.state.searchable} />
