...
var Select = (function (_React$Component) {
   ...
   */
		...
		value: function renderClear() {
			...
			if (!this.props.clearable || this.props.value === this.getResetValue() || this.props.value === undefined || this.props.value === null || this.props.multi && !this.props.value.length || this.props.disabled || this.props.isLoading) return;
